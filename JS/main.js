...
function openProjectModal(type) {
    ...
    if (type === 'web') {
        // Placeholder iframe for web project
        body.innerHTML = '<iframe src="https://example.com" title="Live Preview"></iframe>';
    } else {
        // Placeholder for mobile project
        body.innerHTML = '<div class="project-preview-mock"><h3>Превью Мобильного Приложения</h3><p>Мобильные приложения недоступны для просмотра через Web iFrame. Здесь может быть галерея скриншотов проекта.</p></div>';
    }
